...
Right now, Automat Studio only generates the video portion of a shot. But we’re actively working on adding support for dialogue, sound effects, and music in future updates.
